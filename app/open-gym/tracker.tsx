...
import {
  ...
  SCHEDULE_4TEAM_SHORT_2X,
  SCHEDULE_4TEAM_LONG,
  SCHEDULE_5TEAM_SHORT,
  SCHEDULE_5TEAM_SHORT_2X,
  SCHEDULE_5TEAM_LONG,
...
function SchedulePicker({ onSelect }: { onSelect: (key: string) => void }) {
  const groups = [
    ...
    { label: '4-Team', schedules: [SCHEDULE_4TEAM_SHORT, SCHEDULE_4TEAM_SHORT_2X, SCHEDULE_4TEAM_LONG] },
    { label: '5-Team', schedules: [SCHEDULE_5TEAM_SHORT, SCHEDULE_5TEAM_SHORT_2X, SCHEDULE_5TEAM_LONG] },
