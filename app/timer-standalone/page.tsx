  ...
  return (
    <div className="min-h-screen bg-gray-100 py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        {isPlayingAnnouncement && (
          <div className="bg-blue-100 border border-blue-300 rounded-lg p-4 mb-6 animate-pulse">
            <div className="flex items-center gap-3">
              <div className="text-blue-600 text-xl animate-bounce">📢</div>
              <div className="flex-1">
                <h3 className="font-semibold text-blue-800">Making Announcement</h3>
                <p className="text-sm text-blue-700">
                  Background music should be automatically lowered during this announcement.
                </p>
              </div>
            </div>
          </div>
