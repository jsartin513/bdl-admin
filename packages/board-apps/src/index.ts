export type BoardAppId = 'admin' | 'merch' | 'open-gym' | 'concessions';
...
const PROD_APPS: Record<BoardAppId, string> = {
  ...
  concessions: 'https://concessions.bostondodgeballleague.com/admin/dashboard',
};
...
const PREVIEW_APPS: Record<BoardAppId, string> = {
  ...
  concessions: 'https://concessions-preview.bostondodgeballleague.com/admin/dashboard',
};
...
const APP_LABELS: Record<BoardAppId, string> = {
  ...
  concessions: 'Concessions Admin',
};

const ALL_APP_IDS: BoardAppId[] = ['admin', 'merch', 'open-gym', 'concessions'];
